...
/* package Tdcool-0.1.0.0 */
#ifndef VERSION_Tdcool
#define VERSION_Tdcool "0.1.0.0"
#endif /* VERSION_Tdcool */
#ifndef MIN_VERSION_Tdcool
#define MIN_VERSION_Tdcool(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Tdcool */
...
#define CURRENT_COMPONENT_ID "Tdcool-0.1.0.0-inplace-Tdcool"
